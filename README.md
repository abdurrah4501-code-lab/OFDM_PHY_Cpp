...
1, system_parameters.h contains all necessary system parameters such as Number of subcarriers, Constellation size, Cyclic prefix size, power delay profile, etc
